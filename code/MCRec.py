...
def get_model(usize, isize, path_nums, timestamps, length, layers=[20, 10], reg_layers=[0, 0], latent_dim=40,
    ...
    if metapath == 'all':
        ...
        if metapath[1:] == 'uuum':
            path_output = uuum_latent
        elif metapath[1:] == 'umtmum':
            path_output = umtmum_latent
        elif metapath[1:] == 'umum':
            path_output = umum_latent
        elif metapath[1:] == 'umtm':
            path_output = umtm_latent
...
if __name__ == '__main__':
    ...
    t1 = time()
    dataset = Dataset('../data/ml-100k/' + dataset)
